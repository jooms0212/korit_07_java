...
/*
    method - 순차적으로 실행되는 여러 코드들을 하나의 이름으로 묶은 것
        저희는 call1() - call4()로, 매개변수 유무 / return 유무로 구현했습니다.
...
//    }
    ...
    // writeSchedule(20250804, "메서드/오버로딩/클래스 예습"); 을 호출하시오.

    // 2. call2() 유형으로 작성할겁니다. -> main에 어떻게 쓸지, 아닐지 고민해야하죠.
    // divideBySeven 메서드를 정의할겁니다.
    ...
    // 임의의 숫자를 입력하세요 >>> 100
    // 100은 7의 배수가 아닙니다.
    // 2.를 다 하신 분은 overlodading을 통해서 call1() 유형으로도 만들어보세요.
...
//        reviewMethod1.writeSchedule(20250804, "메서드/오버로딩/클래스 예습");
//
//        Scanner scanner = new Scanner(System.in);
//        int num;
//        System.out.println("임의의 숫자를 입력하세요 >>>");
