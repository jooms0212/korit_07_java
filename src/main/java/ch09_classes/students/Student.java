...
/*
    ...
    6. studentCode, name, score를 매개변수로 하는 매개변수 생성자를 정의,
        "int, String, double 매개변수 생성자로 객체를 생성했습니다."라고 출력되는
        코드를 작성하시오.

    7. StudentMain 클래스에, 해당 객체명과 속성명을 가질 수 있도록 작성하시오.
        1) student1 2025001 / 김일 / 4.5 -> 기본생성자
        1) student2 2025002 / 김이 / 100 -> int 매개변수 생성자
        1) student3 2025003 / 김삼 / 95.8 -> String 매개변수 생성자
        1) student4 2025004 / 김사 / 4.0 -> int, String 매개변수 생성자
        1) student5 2025005 / 김오 / 80.7 -> int, String, double 매개변수 생성자

    8. 학생의 정보가 출력될 수 있도록 하는 showInfo() 메서드를 call1() 타입으로 정의하시오.

    9. 실행 예
        기본 생성자로 객체가 생성되었습니다.
        int 매개변수 생성자로 객체를 생성했씁니다.
