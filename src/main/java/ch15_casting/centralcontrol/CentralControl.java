...
public class CentralControl {
    ...
    public void addDevice(Power device) {
        ...
        /*
                ...
                현재 보시면 method의 결과값을 다시 . 찍어서 그 다음 method를 호출했습니다.
                이상의 개념을 chaining method라고 해서 ruturn값의 유형을 명확하게 알고 있어야
    ...
    private int checkEmpty() {  // 메서드인데 private 썼습니다. Main에서 굳이
        ...
        /*
            ...
            하지만 0과 너무 가까운 수이다보니 -100이라든지, 아니면 return 값으로 나올 수 없을만한
            음수값을 지정하는 경우도 있는데,
    ...
    public void powerOn() {
        ...
        for (int i = 0; i < deviceArray.length; i++) {
            if (deviceArray[i] == null) {
                ...
                continue;
                // break;는 반복문을 즉시 종료,
                // return;은 method를 즉시 종료하는데,
                // continue;의 경우에는 현재 반복만 종료하고 그 다음 반복문으로 넘어갑니다.
    ...
    public void powerOff() {
        for (Power deviceOff : deviceArray) {
            if (deviceOff == null) {
    ...
    // 고유 메서드로 print(0 -> "프린터가 인쇄를 합니다"로 출력될 수 있도록 정의하고,
