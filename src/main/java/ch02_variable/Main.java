...
/*
    주석(comment) : Java 프로그램의 경우 폴더 및 파일의 전체 코드를 컴파일링하는데,
                    ...
                    즉 주석이란 컴퓨터가 알아서 처리하는 부분이 아니라 사람이 읽어서 정보를
                    얻을 수 있는 데에 의의가 있습니다.
...
public class Main {
    public static void main(String[] args) {
        System.out.println("안녕하세요, 제 이름은 안승규입니다.");
//        System.out.println(안녕하세요, 제 이름은 안승규입니다.); // 오류 발생
        ...
        String introduction = "안녕하세요, 저는 이번 국비 과정을 듣게 된 안승규입니다";
        ...
        /*
            Java에서의 변수 명명 규칙 :
                ...
                cf) python 학습하신 분들의 경우 python 변수 표기 방식은 스네이크 표기범
        ...
        char name2 = '승';
        char name3 = '규';
        System.out.println(name1 + name2 + name3); // 결과값 : 144861
        System.out.println('안' + '승' + '규'); // 결과값 : 144861

        System.out.println("" + name1 + name2 + name3); // 결과값: 안승규
        ...
        /*
            ...
            때문에 원하는 방식으로 출력되지 않습니다. 144 어쩌고로 출력됐죠.
        ...
        + "이고, 그래서 제 예전 직업은 " + previousJob + "이었습니다. 현재는 " +
        ...
        /*
            ...
            제 전공은 어쩌고어쩌고학과이며, mbti는 블라블라입니다. 열심히 할게요 !!!'
        ...
        // enter 키 위에 원화 표시 있습니다. 원화표시가 한국에서만 먹히는 형태고 원래는 역슬러시만 표기되어있습니다.
        // \n -> 개행이 일어납니다.
        // \t -> 탭 친 효과가 일어납니다.
