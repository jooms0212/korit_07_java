...
public class Condition03 {
    public static void main(String[] args) {
        ...
        final int VIP_POINT = 80;       // final 키워드가 붙으면 '재대입'이 불가능
        final int GOLD_POINT = 60;      // 즉 변합없는 데이터를 사용하고 싶을때
        final int SILVER_POINT = 40;     // 사용하는데, 얘가 변함없는 데이터임을
        final int BRONZE_POINT = 20;    // 개발자들이 알아보기 위해
