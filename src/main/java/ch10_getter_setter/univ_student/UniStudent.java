...
/*
    ...
    3. Setter / Getter 메서드를 정의하시오.
        ...
        범위를 벗어날 경우 불가능한 입력입니다. 가 출려되도록 비지니스 로직을 작성
    4. UnivStudentMain에서
...
public class UniStudent {
    ...
    public UniStudent(int grade) {
        this.grade = grade;
    }

    public UniStudent(String name, int grade) {
        this.name = name;
        this.grade = grade;
    }

    public UniStudent(String name, int grade, double score) {
        this.name = name;
        this.grade = grade;
        this.score = score;
    }
