...
public class Samsung {
    ...
    public String createSerialNumber(String model) {
        ...
        // 싱글톤으로 작성했으니까 어차피 객체 하나만 생성될거고 Main단계에서 다수의 객체에서
        // createSerialNumber()를 호출하더라도 전혀 serialNumber가 중복되지 않을거라고 볼 수 있습니다.
        // 그러면 정적 변수로 선언하고 다수의 삼성 객체를 만들어도 serialNumber가 연결되지 않을까요 ?
        // 라고 질문한다면 맞는 말입니다.
