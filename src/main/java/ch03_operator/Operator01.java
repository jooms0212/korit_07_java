...
/*
    Camel case -> Java 상에서의 변수 표기범(JS에서도 씁니다)
    Snake case -> 얘는 뭐 Java에서 쓸 일이 없습니다. 근데 전체 상수 사용시에 비슷한 표기법이 적용됩니다.
    Pascal case -> 첫 번째 문자가 대문자고 나머지는 소문자로 가다가 두 번째 단어의 첫 번재 문자는 또 대문자
    ...
    public static void main(String[] args) {
        ...
        /*
            대입 연산자 = : = 왼쪽과 오른쪽이 같다는 의미가 아니라
                = 오른쪽에 있는 데이터를 = 왼쪽에 있는 변수에 '대입'한다는 의미입낟.
        ...
        System.out.println(j);      // 위의 코드가 실행되고 +1 했기 때문에 11 출력
